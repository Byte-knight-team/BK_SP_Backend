...
public class AdminDashboardController {
    ...
    @GetMapping("/summary")
    @PreAuthorize("hasRole('SUPER_ADMIN') or hasAuthority('VIEW_SUMMARY')")
    public ResponseEntity<AdminDashboardSummaryResponse> getSummary() {
        return ResponseEntity.ok(adminDashboardService.getSummary());
    }

    @GetMapping("/order-flow")
    @PreAuthorize("hasRole('SUPER_ADMIN') or hasAuthority('VIEW_ORDER_FLOW')")
    ...
    @PreAuthorize("hasRole('SUPER_ADMIN') or hasAuthority('VIEW_REVENUE_TREND')")
    ...
    @PreAuthorize("hasRole('SUPER_ADMIN') or hasAuthority('VIEW_BRANCH_REVENUE')")
