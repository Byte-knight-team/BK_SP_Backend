...
public class QrCodeController {
    ...
    @PreAuthorize("hasRole('SUPER_ADMIN') or hasAuthority('CREATE_QR_CODE')")
    ...
    @PreAuthorize("hasRole('SUPER_ADMIN') or hasAuthority('VIEW_ACTIVE_QR_CODE')")
    ...
    @PreAuthorize("hasRole('SUPER_ADMIN') or hasAuthority('REVOKE_QR_CODE')")
    ...
    @PreAuthorize("hasRole('SUPER_ADMIN') or hasAuthority('REGENERATE_QR_CODE')")
    ...
    @PreAuthorize("hasRole('SUPER_ADMIN') or hasAuthority('DOWNLOAD_QR_CODE')")
