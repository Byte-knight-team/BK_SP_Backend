...
public class ReceptionistTableServiceImpl implements ReceptionistTableService {
        ...
        @Override
        @Auditable(module = AuditModule.TABLE, eventType = AuditEventType.TABLE_STATUS_UPDATED, targetType = AuditTargetType.TABLE, description = "Table marked as occupied successfully", captureResultAsNewValue = false)
        @Transactional
        ...
        @Override
        @Auditable(module = AuditModule.TABLE, eventType = AuditEventType.TABLE_STATUS_UPDATED, targetType = AuditTargetType.TABLE, description = "Table cleared successfully", captureResultAsNewValue = false)
        @Transactional
        public void clearTable(Long tableId, String userEmail) {
                ...
                // If a reservation starts within 15 minutes, lock the table as RESERVED instead
                // of AVAILABLE
